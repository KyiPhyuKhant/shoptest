...
$module_constant = 'HPPC_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/hp_product_carousels'; // This is the directory your installer is in, usually this is lower case
$module_name = "Home Page Product Carousels"; // This should be a plain English or Other in a user friendly way
