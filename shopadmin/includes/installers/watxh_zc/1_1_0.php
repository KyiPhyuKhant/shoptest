<?php
if (!defined('TABLE_TEMPLATE_CONFIG_GROUP')) {
    require_once(DIR_FS_ADMIN . 'includes/init_includes/init_file_db_names.php');
}
...
{
  	$db->Execute("DELETE FROM " . TABLE_ADMIN_PAGES . " WHERE page_key = 'configWatxh_ZC' LIMIT 1;");
	// add configuration menu
	if (!zen_page_key_exists('configWatxh_ZC'))
	{
		...
		{
			zen_register_admin_page('configWatxh_ZC', 'BOX_CONFIGURATION_WATXH_ZC_OPTIONS', 'FILENAME_TEMPLATE_CONFIGURATION', '', 'tools', 'N', $configuration_group_id);
