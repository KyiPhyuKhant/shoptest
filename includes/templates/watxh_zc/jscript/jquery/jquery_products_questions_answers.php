...
var PRODUCTS_QUESTIONS_ANSWERS_ALLOW_QUESTS_ASKING_QUESTIONS = <?php echo (defined('PRODUCTS_QUESTIONS_ANSWERS_ALLOW_QUESTS_ASKING_QUESTIONS') && PRODUCTS_QUESTIONS_ANSWERS_ALLOW_QUESTS_ASKING_QUESTIONS == 'true') ? 'true' : 'false'; ?>;
//--></script>